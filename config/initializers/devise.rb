...
Devise.setup do |config|
  ...
  config.mailer_sender = 'please-change-me-devise@example.com'
  ...
  # These keys will be downcased upon creating or modifying a
  # user and when used
  ...
  # If using other algorithms, it sets how many times you want the
  ...
  # config.pepper = 'add_pepper_hash_here'
  ...
  # bcrypt (default). You can use :sha1, :sha512 or algorithms from others
